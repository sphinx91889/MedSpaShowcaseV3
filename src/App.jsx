...
import AppointmentPage from './pages/AppointmentPage'; // Import AppointmentPage
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/appointment" element={<><Navigation /><AppointmentPage /></>} /> {/* Add AppointmentPage route */}
      </Routes>
    </Router>
  );
}
